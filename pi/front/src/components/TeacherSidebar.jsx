...
import { LayoutDashboard, Users, ClipboardCheck, ListChecks, FileText, Settings, LogOut, User, MessageCircle, AlertCircle, ExternalLink } from 'lucide-react';
...
const TeacherSidebar = () => {
  ...
  const navItems = [
    { to: '/teacher/dashboard', icon: LayoutDashboard, label: t('sidebar.dashboard'), section: 'main' },
    { to: '/teacher/students', icon: Users, label: t('sidebar.students'), section: 'main' },
    { to: '/teacher/evaluate', icon: ClipboardCheck, label: t('sidebar.evaluate'), section: 'main' },
    { to: '/teacher/evaluations', icon: ListChecks, label: t('sidebar.evaluations'), section: 'main' },
    ...
    <>
      ...
      >
        <div className="sidebar-header">
          <a href="/teacher/dashboard" className="sidebar-logo">
