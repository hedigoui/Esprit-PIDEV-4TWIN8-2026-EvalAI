...
import { LayoutDashboard, Users, FileText, Settings, LogOut, User, MessageCircle, AlertCircle, ExternalLink } from 'lucide-react';
...
const AdminSidebar = () => {
  ...
  const navItems = [
    { to: '/admin/dashboard', icon: LayoutDashboard, label: t('sidebar.dashboard'), section: 'main' },
    { to: '/admin/users', icon: Users, label: t('sidebar.users'), section: 'main' },
    { to: '/admin/reports', icon: FileText, label: t('sidebar.reports'), section: 'main' },
    { to: '/admin/reclamations', icon: AlertCircle, label: t('sidebar.reclamations'), section: 'main' },
    ...
    { to: '/admin/settings', icon: Settings, label: t('sidebar.settings'), section: 'account' },
  ];
